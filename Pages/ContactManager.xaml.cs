...
namespace IPRMetadata.Pages
{
  internal class ContactManagerSidebarLabel : ISidebarLabel
  {
    ...
    {
      get { return IPRMetadata.Properties.Resources.CFG_LBL_CONTACT_MGR; }
    }    
  }
  /// <summary>
  ...
  internal partial class MTK_ContactManager : EditorPage
  {
    ...
    public void OnUnCheck(object sender, RoutedEventArgs e)
    {
      ...
      if (false == check && "external".Equals(tagNode.InnerText))
      {
        ...
        // show dialog
        MessageBoxResult result = ArcGIS.Desktop.Internal.Framework.DialogManager.ShowMessageBox(IPRMetadata.Properties.Resources.LBL_CM_Confirm, IPRMetadata.Properties.Resources.LBL_CM_ConfirmTitle, button, icon);
